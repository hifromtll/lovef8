  ...
  return (
    <main style={{ padding: 24, maxWidth: 1100, margin: '0 auto', color: 'white' }}>
      ...
      >
        ...
        >
          <div style={{ flex: '1 1 680px', minWidth: 280 }}>
            ...
            <h1 style={{ margin: 0, fontSize: 34 }}>Host Dashboard</h1>

            <p style={{ marginTop: 10, color: '#d4d4d8', maxWidth: 700, lineHeight: 1.5 }}>
              Members can apply to become hosts, complete readiness steps, and prepare for
              approval.
            </p>
            ...
            >
              ...
              >
                <div style={{ fontSize: 12, color: '#a1a1aa' }}>Pending</div>
              ...
              >
                <div style={{ fontSize: 12, color: '#a1a1aa' }}>Paid</div>
                <div style={{ fontSize: 22, fontWeight: 700 }}>
          ...
          >
            Status: {prettyHostStatus(hostStatus)}
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          <h2 style={{ marginTop: 0 }}>Host Readiness</h2>
          ...
          >
            ...
            >
              ...
              <div style={{ textAlign: 'right' }}>
                <div style={{ color: '#a1a1aa', fontSize: 13 }}>Photos found</div>
          ...
          <div style={{ marginTop: 16, display: 'grid', gap: 10 }}>
            {checklist.map((item) => (
              ...
              >
                <span style={{ color: '#f4f4f5' }}>{item.label}</span>
        ...
        <section style={{ display: 'grid', gap: 20 }}>
          ...
          >
            ...
            <div style={{ marginTop: 16, display: 'grid', gap: 12 }}>
              ...
              >
                <div style={{ fontWeight: 700 }}>ID Verification</div>
              ...
              >
                <div style={{ fontWeight: 700 }}>Selfie Verification</div>
                <div style={{ marginTop: 6, fontSize: 14 }}>
          ...
          >
            <h2 style={{ marginTop: 0 }}>Application State</h2>
            <p style={{ color: '#d4d4d8', marginTop: 8 }}>
          ...
          >
            ...
            <div style={{ marginTop: 18 }}>
              ...
              <textarea
                ...
                placeholder="Enter your PayPal email, GCash number, bank info, or other payout details"
                style={{
                  padding: 12,
                  borderRadius: 14,
                  border: '1px solid #3f3f46',
